...
def login_req(request):
    return render(request, 'onsis/login.html',)
...
def logout_user(request):
    ...
    '''
    auth.logout(request)
    return render(request, 'onsis/login.html', {'mensagem': 'Você saiu do sistema!', 'status': 'info'})
...
def login_user(request):
    ...
    return render(request, 'onsis/login.html', {'mensagem': 'usuário/senha inválidos', 'status': 'danger'})
